...
import vn.backend.jobhunter.domain.response.RestResponse;
...
public class GlobalException {
    ...
    public ResponseEntity<RestResponse<Object>> handelIdException(Exception ex) {
    ...
    public ResponseEntity<RestResponse<Object>> handelFileUploadException(Exception ex) {
        RestResponse<Object> res = new RestResponse<Object>();
        res.setStatusCode(HttpStatus.BAD_REQUEST.value());
        res.setError(ex.getMessage());
    ...
    public ResponseEntity<RestResponse<Object>> handelPermissionException(Exception ex) {
        RestResponse<Object> res = new RestResponse<Object>();
