...
import vn.backend.jobhunter.repository.PermissionRepository;
import vn.backend.jobhunter.repository.RoleRepository;
...
public class DatabaseInitializer implements CommandLineRunner {
    ...
    public void run(String... args) throws Exception {
        ...
        if (countRoles == 0) {
            List<Permission> allPermit = this.permissionRepository.findAll();

            Role adminRole = new Role();
            adminRole.setName("SUPER_ADMIN");
            adminRole.setDescription("full permission");
            adminRole.setActive(true);
            adminRole.setPermissions(allPermit);
